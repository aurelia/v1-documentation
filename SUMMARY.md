...
* [Template syntax](templates/template-syntax/README.md)
  ...
  * [Delegate vs trigger](templates/template-syntax/delegate-vs-trigger.md)
...
* [Server side rendering](getting-to-know-aurelia/server-side-rendering/README.md)
  * [Setup and installation](getting-to-know-aurelia/server-side-rendering/setup-and-installation.md)
  ...
  * [Middleware configuration](getting-to-know-aurelia/server-side-rendering/middleware-configuration.md)
  ...
  * [Troubleshooting](getting-to-know-aurelia/server-side-rendering/troubleshooting.md)
* [CLI](getting-to-know-aurelia/cli/README.md)
  ...
  * [Command reference](getting-to-know-aurelia/cli/command-reference.md)
...
* [Store](aurelia-packages/store/README.md)
  * [Configuring your app](aurelia-packages/store/configuring-your-app.md)
  * [What is the State?](aurelia-packages/store/what-is-the-state.md)
  * [Reasons for state management](aurelia-packages/store/reasons-for-state-management.md)
  * [Subscribing to the stream of states](aurelia-packages/store/subscribing-to-the-stream-of-states.md)
  * [Subscribing with the connectTo decorator](aurelia-packages/store/subscribing-with-the-connectto-decorator.md)
  * [What are actions?](aurelia-packages/store/what-are-actions.md)
  * [Async actions](aurelia-packages/store/async-actions.md)
  * [Dispatching actions](aurelia-packages/store/dispatching-actions.md)
  * [Resetting the store to a specific state](aurelia-packages/store/resetting-the-store-to-a-specific-state.md)
  * [Two-way binding and state management](aurelia-packages/store/two-way-binding-and-state-management.md)
  * [Recording a navigable history of the stream of states](aurelia-packages/store/recording-a-navigable-history-of-the-stream-of-states.md)
  * [Making our app history-aware](aurelia-packages/store/making-our-app-history-aware.md)
  * [Navigating through history](aurelia-packages/store/navigating-through-history.md)
  * [Handling side-effects with middleware](aurelia-packages/store/handling-side-effects-with-middleware.md)
  * [Accessing the original (unmodified) state in a middleware](aurelia-packages/store/accessing-the-original-unmodified-state-in-a-middleware.md)
  * [Defining settings for middlewares](aurelia-packages/store/defining-settings-for-middlewares.md)
  * [Error Propagation with Middlewares](aurelia-packages/store/error-propagation-with-middlewares.md)
  * [Default middlewares](aurelia-packages/store/default-middlewares.md)
  * [Tracking overall performance](aurelia-packages/store/tracking-overall-performance.md)
  * [Defining custom devToolsOptions](aurelia-packages/store/defining-custom-devtoolsoptions.md)
  * [Defining custom loglevels](aurelia-packages/store/defining-custom-loglevels.md)
  * [Debugging with the Redux devtools extension](aurelia-packages/store/debugging-with-the-redux-devtools-extension.md)
  * [Comparison to other state management libraries](aurelia-packages/store/comparison-to-other-state-management-libraries.md)
